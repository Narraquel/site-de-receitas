...
1. Baixar ou clonar o repositório:
   ```bash
   git clone https://github.com/Narraquel/site-de-receitas.git
   ```
2. Abrir o arquivo `index.html` no seu navegador (clique duplo no arquivo já funciona).
...
Feito com carinho por **Ana Raquel** ([@Narraquel](https://github.com/Narraquel)).

---

*Sugestões de receitas e melhorias são sempre bem-vindas! Fique à vontade para abrir uma issue.*
